...
const commands = [
  new SlashCommandBuilder().setName('청소').setDescription('청소갯수').addNumberOption(option => option.setName('숫자1').setDescription('최대 99개')).setDefaultMemberPermissions(0),
  ...
  new SlashCommandBuilder().setName('딜레이박스').setDescription('지연 전송할 말').addStringOption(option => option.setName('딜레이말').setDescription('메시지넣기')).addNumberOption(option => option.setName('시간').setDescription('ex)1분=60,max15분')).setDefaultMemberPermissions(0),
